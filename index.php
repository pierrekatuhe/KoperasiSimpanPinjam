...
<!-- Mirrored from xvelopers.com/demos/html/paper-panel/login-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Sep 2019 16:23:18 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="col-lg-4 mx-md-auto">
                    ...
                    <form id="frmz">
                        <div class="form-group has-icon"><i class="icon-user"></i>
                            <input type="text" class="form-control form-control-lg" name="no_id" placeholder="Nomor Identitas">
                        </div>
